...
## Комплект для развёртывания

Готовый каталог: [`Мониторинг заббикс 1646642`](Мониторинг%20заббикс%201646642).

На рабочей машине он должен лежать здесь:

`C:\Работа\Заслон\Мониторинг заббикс 1646642`

Архив: [`Мониторинг заббикс 1646642.zip`](Мониторинг%20заббикс%201646642.zip) — распаковать в `C:\Работа\Заслон\`.

Дальше: `РАЗВЕРТЫВАНИЕ.md` и `01-Хост-Windows\Install-ZabbixAgent.ps1`.
